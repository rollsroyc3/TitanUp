...
function UIViewsDemoWindow() {
	...
	_tv_menu.addEventListener('click', function(e) {
		...
		switch (e.row.title) {
			...
			case rows[4].title:
				var UIViewsDatePickerDemoWindow = require('/ui/UIViewsDatePickerDemoWindow');
				win = new UIViewsDatePickerDemoWindow();
				break;
				
			case rows[5].title:
				var UIViewsToastDemoWindow = require('/ui/UIViewsToastDemoWindow');
				win = new UIViewsToastDemoWindow();
				break;
